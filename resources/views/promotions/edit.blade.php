...
@section('title', 'Edit Promosi - PromoHub')

@section('content')
    <div class="max-w-2xl mx-auto">
        <h1 class="text-3xl font-bold mb-6">Edit Promosi</h1>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('promotions.update', $promotion) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('promotions.show', $promotion) }}" class="btn btn-secondary">Batal</a>
                    <button type="submit" class="btn btn-primary">Perbarui Promosi</button>
                </div>
            </form>
        </div>
    </div>
